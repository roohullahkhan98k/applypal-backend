...
export declare class AdminService {
    ...
    getAllUniversities(page?: number, limit?: number): Promise<{
        universities: {
            id: string;
            userId: string;
            fullName: string;
    ...
    getAllAmbassadors(page?: number, limit?: number): Promise<{
        ambassadors: {
            id: string;
            userId: string;
            fullName: string;
    ...
    getAllChatClicks(page?: number, limit?: number): Promise<{
        chatClicks: {
            id: string;
            widgetId: string;
            domain: string;
    ...
    getAllInvitations(page?: number, limit?: number): Promise<{
        invitations: {
            id: string;
            universityId: string;
            universityName: string;
