...
export declare class AmbassadorService {
    ...
    createProfile(userId: string, profileData: CreateAmbassadorProfileDto, file?: Express.Multer.File): Promise<{
        user: {
            university: string;
            fullName: string;
            email: string;
    ...
    updateProfile(userId: string, profileData: UpdateAmbassadorProfileDto, file?: Express.Multer.File): Promise<{
        user: {
            university: string;
            fullName: string;
            email: string;
